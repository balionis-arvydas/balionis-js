...
describe('AppComponent', () => {
  ...
  it(`should have as title 'balionis-angular3'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.debugElement.componentInstance;
    expect(app.title).toEqual('balionis-angular3');
  });
  ...
  it('should render title in a h1 tag', () => {
    ...
    expect(compiled.querySelector('h1').textContent).toContain('Welcome to balionis-angular3!');
  });
